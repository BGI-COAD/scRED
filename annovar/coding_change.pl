...
our $VERSION = 			'$Revision: 475 $';
our $LAST_CHANGED_DATE =	'$LastChangedDate: 2011-06-18 12:13:01 -0700 (Sat, 18 Jun 2011) $';

our ($verbose, $help, $man, $includesnp);
...
GetOptions('verbose|v'=>\$verbose, 'help|h'=>\$help, 'man|m'=>\$man, 'includesnp'=>\$includesnp) or pod2usage ();
...
=head1 SYNOPSIS
 ...
 Function: infer the translated protein sequence for frameshift mutations 
 ...
 Version: $LastChangedDate: 2011-06-18 12:13:01 -0700 (Sat, 18 Jun 2011) $
